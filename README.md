...
> 안녕하세요! "노력은 재능을 이길수 없다고 하지만" 재능은 만들 수 있다고 생각하며 하루하루 성장하고 있는 신입 개발자 김병훈 입니다.
>  
> 저는 지금도 성장하기 위해 기본기를 중요하게 생각하여 기본기를 튼튼하게 하기 위해 꾸준히 시간을 투자하고 있습니다.  
>
> H/Ev Parking 시스템은 첫 개인 프로젝트 입니다. 지금 되돌아보니 부족한게 많은 프로젝트 이지만 열심히 만들었으니 재밌게 봐주세요 😄
>
> 프로젝트 시연 영상은 마지막에 있습니다.(7분정도! 화질은 꼭 HD화질로 보세요!!)
> 
> 저에 대해 궁금하거나 같이 공부를 원하신다면 언제든지 제 개인 블로그에 놀러 와 주세요(계속 업데이트중 입니다.) <a href="https://bunghoon1.tistory.com/">🏠(클릭)</a>
>
<br/><br/><br/><br/>
